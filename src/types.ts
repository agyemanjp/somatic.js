...
export type PropsExtended<PropsCore extends Obj, Msg extends Message = Message> = PropsCore & {
...
export type VNodeType<P extends Obj = Obj> = Component<P> | string /* Intrinsic element */
...
export type Component<Props extends Obj = Obj, Msg extends Message = Message> = (props: PropsExtended<Props, Msg>) => JSX.Element

...
// }
//
// export interface IntrinsicElement<P extends Obj = Obj>
//     extends UIElementBase<P> {
//     type: string
// }
//
...
//  */
// // eslint-disable-next-line @typescript-eslint/ban-types
// export type UIElement<P extends Obj = Obj> =
//     | ComponentElt<P>
//     | IntrinsicElement<P>
//     | /*FragmentElement |*/ ValueElement
//
...
// }
//
// export interface ComponentEltAugmented<P extends Obj = Obj>
//     extends ComponentElt<P> {
//     result: ComponentResult
// }
//
...
//         | `${string} ${number} ${"normal" | "reverse" | "alternate" | "alternate-reverse"} ${"none" | "forward" | "backward" | "both"} ${"running" | "paused"} ${string}`
//         );

...
export const PlaceHolder = create(
	<svg
		xmlns="http://www.w3.org/2000/svg"
		xmlnsXlink="http://www.w3.org/1999/xlink"
		x="0px" y="0px"
		viewBox="0 0 290.99 290.99"
		style={{ enableBackground: "0 0 290.99 290.99" }}
		xmlSpace="preserve">
		<g>
			<path
				style={{ fill: "#010002" }}
		...
		h197.623c6.005,0,10.878,4.873,10.878,10.878V219.828z"/>
			<path
				style={{ fill: "#010002" }} d="M73.427,216.434h164.08c6.005,0,9.616-4.699,8.044-10.508l-26.069-96.837

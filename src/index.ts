...
declare global {
	export namespace JSX {
		...
		interface IntrinsicElements {
			 ...
			 */
			hr: Intrinsic<HTMLAttributes<HTMLHRElement>>
			 ...
			 */
			dl: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			dt: Intrinsic<HTMLAttributes<HTMLElement>>
			/** Represents a caption or legend describing the rest of the contents of its parent figure element. */
			figcaption: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			figure: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			abbr: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			br: Intrinsic<HtmlHTMLAttributes<HTMLBRElement>>
			 ...
			 */
			bdi: Intrinsic<HTMLAttributes<HTMLElement>>
			/** Overrides the current directionality of text, so that the text within is rendered in a different direction. */
			bdo: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			cite: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			code: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			data: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			kbd: Intrinsic<HTMLAttributes<HTMLElement>>
			...
			mark: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			q: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			rp: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			rt: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			ruby: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			s: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			samp: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			small: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			strong: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			sub: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			sup: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			time: Intrinsic<HTMLAttributes<HTMLTimeElement>>
			 ...
			 */
			u: Intrinsic<HTMLAttributes<HTMLTimeElement>>
			 ...
			 */
			var: Intrinsic<HTMLAttributes<HTMLTimeElement>>
			 ...
			 */
			wbr: Intrinsic<HTMLAttributes<HTMLTimeElement>>
			//#endregion
			 ...
			 */
			area: Intrinsic<HTMLAttributes<HTMLAreaElement>>
			/** Embeds an image into the document. */
			img: Intrinsic<ImgHTMLAttributes<HTMLImageElement>>
			 ...
			 */
			audio: Intrinsic<AudioHTMLAttributes<HTMLAudioElement>>
			 ...
			 */
			track: Intrinsic<HTMLAttributes<HTMLTrackElement>>
			/** Used with area elements to define an image map (a clickable link area). */
			map: Intrinsic<HTMLAttributes<HTMLMapElement>>
			//#endregion
			 ...
			 */
			embed: Intrinsic<HTMLAttributes<HTMLElement>>;
			/** Represents a nested browsing context, embedding another HTML page into the current one. */
			iframe: Intrinsic<HTMLAttributes<HTMLElement>>
			/** Represents an external resource, which can be treated as an image, a nested browsing context, or a resource to be handled by a plugin. */
			object: Intrinsic<HTMLAttributes<HTMLElement>>
			/** Defines parameters for an object element. */
			param: Intrinsic<HTMLAttributes<HTMLElement>>
			...
			picture: Intrinsic<HTMLAttributes<HTMLElement>>
			...
			portal: Intrinsic<HTMLAttributes<HTMLElement>>
			...
			//#region Scripting
			script: Intrinsic<ScriptHTMLAttributes<HTMLScriptElement>>,
			noscript: Intrinsic<HtmlHTMLAttributes<HTMLElement>>,
			canvas: Intrinsic<CanvasHTMLAttributes<HTMLCanvasElement>>,
			//#endregion

			//#region Table content
			table: Intrinsic<TableHTMLAttributes<HTMLTableElement>>,
			th: Intrinsic<ThHTMLAttributes<HTMLTableHeaderCellElement>>,
			...
			details: Intrinsic<HTMLAttributes<HTMLElement>>
			dialog: Intrinsic<HTMLAttributes<HTMLElement>>;
			menu: Intrinsic<HTMLAttributes<HTMLElement>>;
			summary: Intrinsic<HTMLAttributes<HTMLElement>>;
			//#endregion
			...
			fieldset: Intrinsic<HTMLAttributes<HTMLFieldSetElement>>
			/** Represents a caption for the content of its parent fieldset. */
			legend: Intrinsic<HTMLAttributes<HTMLLegendElement>>
			/** Represents either a scalar value within a known range or a fractional value. */
			meter: Intrinsic<HTMLAttributes<HTMLMeterElement>>
			...
			datalist: Intrinsic<HTMLAttributes<HTMLDataListElement>>
			...
			output: Intrinsic<HTMLAttributes<HTMLOutputElement>>
			/** Displays an indicator showing the completion progress of a task, typically displayed as a progress bar. */
			progress: Intrinsic<HTMLAttributes<HTMLProgressElement>>
			//#endregion

			//#region Misc
			math: Intrinsic<HTMLAttributes<HTMLElement>>
			frame: Intrinsic<HTMLAttributes<HTMLFrameElement>>
			 ...
			 */
			del: Intrinsic<HTMLAttributes<HTMLElement>>
			 ...
			 */
			ins: Intrinsic<HTMLAttributes<HTMLElement>>
			//#endregion

			//#region SVG
			svg: Intrinsic<SVGAttributes<SVGSVGElement>>,
			g: Intrinsic<SVGAttributes<SVGGElement>>,
			circle: Intrinsic<SVGAttributes<SVGCircleElement>>,
			animate: Intrinsic<SVGAttributes<SVGAnimateElement>>,
			animateTransform: Intrinsic<SVGAttributes<SVGAnimateTransformElement>>,
			rect: Intrinsic<SVGAttributes<SVGRectElement>>,
			line: Intrinsic<SVGAttributes<SVGLineElement>>,
			polyline: Intrinsic<SVGAttributes<SVGPolylineElement>>,
			path: Intrinsic<SVGAttributes<SVGPathElement>>,
			polygon: Intrinsic<SVGAttributes<SVGPolygonElement>>,
			switch: Intrinsic<SVGAttributes<SVGSwitchElement>>,
			desc: Intrinsic<SVGAttributes<SVGDescElement>>,
			foreignObject: Intrinsic<SVGAttributes<SVGForeignObjectElement>>,
			text: Intrinsic<SVGAttributes<SVGTextElement>>,
			defs: Intrinsic<SVGAttributes<SVGDefsElement>>,
			linearGradient: Intrinsic<SVGAttributes<SVGLinearGradientElement>>,
			stop: Intrinsic<SVGAttributes<SVGStopElement>>,
			filter: Intrinsic<SVGAttributes<SVGFilterElement>>,
			clipPath: Intrinsic<SVGAttributes<SVGClipPathElement>>,
			use: Intrinsic<SVGAttributes<SVGUseElement>>,
			//#endregion
		}
	}
}

...
//     columnRule?:
//         | NamedBorderStyle
//         | `${NamedBorderStyle} ${CSSColor}`
//         | `${NamedBorderStyle} ${CSSLength}`;
//     columnRuleColor?:
//         | CSSColor
//         | `hsla(${number}, ${CSSLength}, ${CSSLength}, ${number})`;
...
//         | NamedBorderStyle
//         // color | style
//         | `${CSSColor} ${NamedBorderStyle}`
//         // style | width
//         | `${NamedBorderStyle} ${NamedBorderWidth}`
//         // color | style | width
//         | `${CSSColor} ${NamedBorderStyle} ${NamedBorderWidth}`;
//     outlineColor?:
//     // color values
//         | CSSColor
//         // keyword value

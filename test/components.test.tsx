...
import { StackPanel, Alert, StackView } from '../dist/components/index.js'
...
describe("Components", () => {
    ...
    describe("StackView", () => {
        it("should render the element and its children with the default props", async () => {
            ...
            assert.equal(container!.children[0].children[0].children[1].textContent, 'test0')
        })
    })
